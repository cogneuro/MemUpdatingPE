...
Bonferroni 보정 후, List 1과 2의 차이는 여전히 유의미하다.
...
contrast(p2AttrErr.emm, con, adjust = "bonferroni")
```
...
contrast(p2PE.emm, con, adjust = "Bonferroni")
```  

실험집단에서만 PE100의 침범반응이 PE30과 PE70보다 적었다. 
...
emm.t[[1]] %>%  contrast(interaction = c("poly", "consec"), 
